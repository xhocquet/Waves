...
let importFolderTextarea = document.querySelector(".importFolders");
let minimizeOnCloseCheckbox = document.querySelector(".minimizeOnClose");
let hotkeyInputs = document.querySelectorAll(".hotkeyInput");
let trackGroupingMethodSelect = document.querySelector(".trackGroupingMethod");
...
let noticePopup = document.querySelector(".noticePopup");
